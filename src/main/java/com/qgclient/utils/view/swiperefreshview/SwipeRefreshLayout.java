 ...
 * Description:  只能在继承AbsListView的组件上正常使用
 * Author: Sungle (jinghao530@gmail.com)
 * Date: 2015/12/6 15:30
 */
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private CircleImageViewRefresh mCircleView;
    ...
    private void createProgressView() {
        mCircleView = new CircleImageViewRefresh(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
